                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="table-actions">
                                                                <a
                                                                    href="{{ route('manual.show.notification.single', $notification->id) }}"><i
                                                                        class="ik ik-eye"></i></a>
                                                                <br>
                                                                <form
                                                                    action="{{ route('manual.notifications.edit', $notification->id) }}"
                                                                    method="GET"
                                                                ...
                                                                <p></p>
                                                                <form
                                                                    action="{{ route('manual.notifications.destroy', $notification->id) }}"
